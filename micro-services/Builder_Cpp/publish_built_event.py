...
future = publisher.publish(topic_name, b'', entryPoint='built', targetFolderName=sys.argv[2], challengeId=sys.argv[3], solutionId=sys.argv[4], imageName='cpp-runner', secretName=sys.argv[5])
print(future.result())