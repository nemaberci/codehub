						...
						<article className="prose overflow-auto max-w-none">
							<p>
								...
								<p>
									...
									and bring punched cards back by introducing a new language called
									<i>Punched Card Python</i> that lets people code in Python using punched cards! Like
									good disrupters, they are going to launch a viral campaign to promote their new
									language before even having the design for a prototype. For the campaign, they want to
									draw punched cards of different sizes in ASCII art.
								</p>
								<p>
									<img
								...
								<p>
									The ASCII art of a punched card they want to draw is similar to an <b>R x C</b> matrix
									without the top-left cell. That means, it has <b>( R . C ) - 1</b>cells in total. Each
									cell is drawn in ASCII art as a period (<code>.</code>) surrounded by dashes (
									<code>-</code>) above and below, pipes (<code>|</code>) to the left and right, and plus
									signs (<code>+</code>) for each corner. Adjacent cells share the common characters in
									the border. Periods (<code>.</code>) are used to align the cells in the top row.
								</p>
								<p>
									For example, the following is a punched card with <b>R = 3</b> rows and <b>C = 4</b>
									columns:
								</p>
								<p></p>
								<pre>..+-+-+-+ ..|.|.|.| +-+-+-+-+ |.|.|.|.| +-+-+-+-+ |.|.|.|.| +-+-+-+-+</pre>
								...
								<p>
									...
									describing the size of a punched card, print the ASCII art drawing of it as described
									above.
								</p>
									...
									<div className="sampleio-wrapper">
										<div className="sample-input">
											...
											<div className="sample-content">
												<pre className="sample-content-text" id="sample_input_0">
													3 3 4 2 2 2 3
												</pre>
											</div>
										</div>
										<div className="sample-output">
											...
											<div className="sample-content">
												<pre className="sample-content-text" id="sample_output_0">
													Case #1: ..+-+-+-+ ..|.|.|.| +-+-+-+-+ |.|.|.|.| +-+-+-+-+ |.|.|.|.| +-+-+-+-+
													Case #2: ..+-+ ..|.| +-+-+ |.|.| +-+-+ Case #3: ..+-+-+ ..|.|.| +-+-+-+ |.|.|.|
													+-+-+-+
												</pre>
								...
								<p>
									Sample Case #1 is the one described in the problem statement. Sample Cases #2 and #3
									are additional examples. Notice that the output for each case contains exactly
									<span className="MathJax_Preview">
